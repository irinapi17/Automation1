...
public class T2_getText_getAttribute {
    ...
    /*
    got o url : https://loopcamp.vercel.app/registration_form.html
    verify the header text expected: Registration form
    verify placeholder  attribut value expected - username
     */
...
WebElement userNamePlaceHolder = driver.findElement(By.name("username"));
        ...
        if(actualPlaceHolderForUsername.equals(LoopCampConstants.EXPECTED_PLACEHOLDER_USERNAME)){
            System.out.println("Expected placeholder for form: \"" + LoopCampConstants.EXPECTED_PLACEHOLDER_USERNAME +
                    "\", matches actual header: \"" + actualPlaceHolderForUsername + "\" = Test PASSED");
        } else {
            System.out.println("Expected placeholder  for form: \"" + LoopCampConstants.EXPECTED_PLACEHOLDER_USERNAME +
                    "\", DOES NOT match actual header: \"" + actualPlaceHolderForUsername);
            System.err.println("TEST FAILED");
    }
}
}
